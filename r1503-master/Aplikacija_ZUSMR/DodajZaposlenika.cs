...
namespace Aplikacija_ZUSMR
{
    public partial class DodajZaposlenika : Form
    {
        ...
        {
            bool uneseno = true;
            if (txtIme.Text.Length < 2 || txtPrezime.Text.Length < 2 || txtKorisnicko.Text.Length < 2 || txtLozinka.Text.Length < 2)
            {
                uneseno = false;
            }
            if (U == 1 && uneseno)
            ...
            {
                MessageBox.Show("Sva polja za unos moraju imat više od dva znaka!");
            }
        }
