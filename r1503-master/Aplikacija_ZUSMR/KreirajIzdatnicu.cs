...
namespace Aplikacija_ZUSMR
{
    public partial class KreirajIzdatnicu : Form
    {
        ...
        public KreirajIzdatnicu()
        {
            ...
            this.txtKreira.Text = Login.ime + " " + Login.prezime;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (lstRacun.Items.Count > 0)
            {
                ...
                MessageBox.Show("Otpremnica kreirana!");
                txtIznos.Text = "";
        ...
        private void cmbKupac_Format(object sender, ListControlConvertEventArgs e)
        {
            string naziv = ((PoslovniEntiteti)e.ListItem).Naziv;
            string kontakt = ((PoslovniEntiteti)e.ListItem).Kontakt;
            e.Value = naziv + " --- " + kontakt;
