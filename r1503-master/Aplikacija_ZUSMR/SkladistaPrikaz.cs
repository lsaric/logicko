...
namespace Aplikacija_ZUSMR
{
    public partial class SkladistaPrikaz : Form
    {
        ...
        private void dgvRefresh()
        {
            ...
            List<JedinicaMjere> jediniceMjere = JedinicaMjere.selectUpit(upit);
            ...
            foreach (Skladiste a in skladiste)
            {
                ...
                for (int i = 0; i < jediniceMjere.Count; i++)
                {
                    if (jediniceMjere[i].ID_JediniceMjere == a.ID_JedinicaMjere)
                    {
                        row.Cells[3].Value = jediniceMjere[i].JMNaziv;
                    }
                }
